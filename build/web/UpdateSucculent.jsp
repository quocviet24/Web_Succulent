        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <div >
                    <div >
                        <div >
                            <h3 class="mb-4 text-center">Update the information about succulent  </h3>
                            ...
                            <form action="add" method="post" class="signin-form">
                                ...
                                <div class="form-group" style="display: flex;">
                                    <br><input id="password-field" type="text" class="form-control" placeholder="Quantity" name="quantity" value>
                                    <br>
